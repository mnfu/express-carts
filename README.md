...
- Twice the speed of vanilla minecarts
...
It adds the "Express Minecart", which has a maximum speed of 16 blocks per second (compared to the default 8) and uses
...
The mod also depends on Polymer, MixinExtras, and the Server Translations API, but these are bundled and need not be installed.
...
There are currently no configurable features of the mod, including the minecart speed, though this is planned.
